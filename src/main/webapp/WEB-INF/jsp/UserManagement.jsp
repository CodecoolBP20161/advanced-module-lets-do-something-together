            ...
            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" ng-model="ctrl.user.email" id="email" class="username form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="email" ng-model="ctrl.user.password_again" id="password_again" class="password_again form-control input-sm" placeholder="Enter your Password again" required/>
                            <div class="has-error" ng-show="myForm.$dirty">
